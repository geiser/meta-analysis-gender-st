...
![](04.b-perform_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
```
    ...
    ## S1                              0.1020 [-0.7230; 0.9271]        6.0     adolescent
    ## S2                             -0.0146 [-0.7647; 0.7355]        7.2     adolescent
    ## S3                              0.0148 [-0.7882; 0.8177]        6.3     adolescent
    ## S4                             -0.8713 [-1.7827; 0.0402]        4.9          adult
    ## S5                              0.1029 [-0.4832; 0.6890]       11.8          adult
    ## S6                              0.1285 [-0.4460; 0.7029]       12.3          adult
    ## S7                              0.0559 [-0.4728; 0.5847]       14.5          adult
    ## S8: Conducted by BNU            0.0335 [-0.7562; 0.8233]        6.5        unknown
    ## S9: Albuquerque, et al. (2017) -0.1973 [-0.7179; 0.3234]       15.0 no-restriction
    ## S10: Only use prompt msgs       0.1040 [-0.4101; 0.6180]       15.4     adolescent
    ## 
    ## Number of studies combined: k = 10
    ## Number of observations: o = 396
    ## 
    ...
    ## Results for subgroups (random effects model):
    ##                        k     SMD            95%-CI   tau^2    tau    Q   I^2
    ## age = adolescent       4  0.0629 [-0.0320; 0.1579]       0      0 0.09  0.0%
    ## age = adult            4 -0.0149 [-0.5770; 0.5472] <0.0001 0.0007 3.85 22.2%
    ## age = unknown          1  0.0335 [-0.7562; 0.8233]      --     -- 0.00    --
    ## age = no-restriction   1 -0.1973 [-0.7179; 0.3234]      --     -- 0.00    --
    ## 
    ## Test for subgroup differences (random effects model):
    ##                     Q d.f. p-value
    ## Between groups   1.12    3  0.7711
    ## 
    ## Details on meta-analytical method:
    ## - Inverse variance method
    ## - Restricted maximum-likelihood estimator for tau^2
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
```
    ...
    ## S10: Only use prompt msgs       0.1040 [-0.4101; 0.6180]       15.4     Brazil:adolescent
    ## 
    ## Number of studies combined: k = 10
    ## Number of observations: o = 396
    ## 
    ...
    ## Results for subgroups (random effects model):
    ##                                       k     SMD            95%-CI   tau^2    tau    Q   I^2
    ## country:age = Brazil:adolescent       4  0.0629 [-0.0320; 0.1579]       0      0 0.09  0.0%
    ## country:age = Brazil:adult            4 -0.0149 [-0.5770; 0.5472] <0.0001 0.0007 3.85 22.2%
    ## country:age = China:unknown           1  0.0335 [-0.7562; 0.8233]      --     -- 0.00    --
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
```
    ...
    ## country:intervention = Brazil:Gender-stereotype color, ...   8 -0.0386 [-0.2560; 0.1789]     0   0 4.37
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
```
    ...
    ## age:intervention = unknown:Gender-stereotype color ...   1  0.0335 [-0.7562; 0.8233]      --     -- 0.00
    ## age:intervention = no-restriction:Gender-stereotyp ...   1 -0.1973 [-0.7179; 0.3234]      --     -- 0.00
    ## age:intervention = adolescent:Gender-stereotyped m ...   1  0.1040 [-0.4101; 0.6180]      --     -- 0.00
    ##                                                          I^2
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
```
    ...
    ## ed.level:intervention = upper-secundary:Gender-stereoty ...   3  0.0306 [-0.1185; 0.1797]      0      0
    ## ed.level:intervention = higher-education:Gender-stereot ...   3 -0.1053 [-1.3579; 1.1473] 0.0881 0.2968
    ## ed.level:intervention = unknown:Gender-stereotype color ...   3 -0.0534 [-0.4235; 0.3166]      0      0
    ## ed.level:intervention = upper-secundary:Gender-stereoty ...   1  0.1040 [-0.4101; 0.6180]     --     --
    ##                                                                Q   I^2
    ## ed.level:intervention = upper-secundary:Gender-stereoty ... 0.04  0.0%
    ## ed.level:intervention = higher-education:Gender-stereot ... 3.75 46.7%
    ## ed.level:intervention = unknown:Gender-stereotype color ... 0.50  0.0%
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
```
    ...
    ## country:age:intervention = China:unknown:Gender-stereotype ...   1  0.0335 [-0.7562; 0.8233]      --     --
    ## country:age:intervention = Brazil:no-restriction:Gender-st ...   1 -0.1973 [-0.7179; 0.3234]      --     --
    ## country:age:intervention = Brazil:adolescent:Gender-stereo ...   1  0.1040 [-0.4101; 0.6180]      --     --
    ##                                                                   Q   I^2
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
![](04.b-perform_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
